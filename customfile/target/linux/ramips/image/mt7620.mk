...
define Device/atsmart_c1
  SOC := mt7620n
  IMAGE_SIZE := 16064k
  DEVICE_VENDOR := Atsmart
  DEVICE_MODEL := C1
  DEVICE_PACKAGES := kmod-usb2 kmod-usb-ohci
  SUPPORTED_DEVICES += c1
endef
TARGET_DEVICES += atsmart_c1

define Device/atsmart_c1-32m
  SOC := mt7620n
  IMAGE_SIZE := 32448k
  DEVICE_VENDOR := Atsmart
  DEVICE_MODEL := C1-32M
  DEVICE_PACKAGES := kmod-usb2 kmod-usb-ohci
  SUPPORTED_DEVICES += c1-32m
endef
TARGET_DEVICES += atsmart_c1-32m
